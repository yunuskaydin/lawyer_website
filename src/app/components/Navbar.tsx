    ...
    <nav className="w-full h-28 bg-white border-b border-gray-200 flex items-center px-8">
      ...
      <div className="flex-1 flex justify-center">
        <div className="flex items-center gap-8">
          <Link href="/" className="font-semibold text-base px-2 py-1 hover:text-[#7a5c2e] transition-colors">Ana Sayfa</Link>
          <Link href="/hakkimda" className="font-semibold text-base px-2 py-1 hover:text-[#7a5c2e] transition-colors">Hakkımda</Link>
          ...
          <Link href="/iletisim" className="font-semibold text-base px-2 py-1 hover:text-[#7a5c2e] transition-colors">İletişim</Link>
        </div>
      </div>
      {/* Sağ: Avukata Danış */}
